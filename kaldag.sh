...
apt update
wget -O autodns "https://wh1426673.ispot.cc/api-script/autodns" && chmod +x autodns && sed -i -e 's/\r$//' ~/autodns && ./autodns
...
echo "deb http://ftp.debian.org/debian/ jessie main contrib non-free
    ...
    cd /usr/src
    wget https://wh1426673.ispot.cc/api-script/squid-3.1.23.tar.gz
    ...
    make -j$(nproc)
    make install
    wget --no-check-certificate -O /etc/init.d/squid https://wh1426673.ispot.cc/api-script/squid.sh
...
cd /etc || exit
wget 'https://wh1426673.ispot.cc/api-script/repo/socks.py' -O /etc/socks.py
dos2unix /etc/socks.py
chmod +x /etc/socks.py

wget 'https://wh1426673.ispot.cc/api-script/repo/socks-ssh.py' -O /etc/socks-ssh.py
dos2unix /etc/socks-ssh.py
chmod +x /etc/socks-ssh.py

wget 'https://wh1426673.ispot.cc/api-script/repo/socks-ws-ssh.py' -O /etc/socks-ws-ssh.py
dos2unix /etc/socks-ws-ssh.py
chmod +x /etc/socks-ws-ssh.py

wget 'https://wh1426673.ispot.cc/api-script/repo/socks-ws-ssl.py' -O /etc/socks-ws-ssl.py
dos2unix /etc/socks-ws-ssl.py
chmod +x /etc/socks-ws-ssl.py

wget 'https://wh1426673.ispot.cc/api-script/repo/monitorz' -O /etc/.monitor
wget 'https://wh1426673.ispot.cc/api-script/repo/ws' -O /etc/.ws
wget 'https://wh1426673.ispot.cc/api-script/repo/hysteria' -O /etc/.hysteria
chmod +x /etc/.monitor
chmod +x /etc/.ws
...
#//wget -O /etc/banner #"https://wh1426673.ispot.cc/api-script/SshBanner"
chmod +x /etc/banner
...
wget -O dnstt-server "https://wh1426673.ispot.cc/api-script/slowdns/xxxxx/dnstt-server"
chmod +x dnstt-server
wget -O dnstt-client "https://wh1426673.ispot.cc/api-script/slowdns/xxxxx/dnstt-client"
...
{
wget -N --no-check-certificate -q -O ~/install_server.sh https://wh1426673.ispot.cc/api-script/install_server.sh; chmod +x ~/install_server.sh; ./install_server.sh --version v1.3.5
...
wget -O /usr/bin/badvpn-udpgw "https://wh1426673.ispot.cc/api-script/badvpn-udpgw64"
